...
class outputLineCheck : public QObject
{
    Q_OBJECT
...
private slots:
    void outputStringOneClass();
    void outputStringOneHundredClasses();
    void thereAreEntriesInAllClasses();
    void twoClassesAreEmpty();
    void allClassesEmpty();
};

outputLineCheck::outputLineCheck()
{
...
void outputLineCheck::outputStringOneClass()
{


    QString inStrRecords = "Стол: размер=[1,2], цвет=[1, 2];"
                           "Мяч: цвет=[1, 2], форма=[1].";

    QString inStrRules = "Запись принадлежит классу \"С покрытием\", если у нее есть свойство \"цвет\".";

    QString expectedResult = "\"С покрытием\": Стол, Мяч";
    Result result;
...
void outputLineCheck::outputStringOneHundredClasses()
{
...
void outputLineCheck::thereAreEntriesInAllClasses()
{
...
void outputLineCheck::twoClassesAreEmpty()
{
    QString inStrRecords = "Автомобиль:мощность=[71,82,31,21], совместимость=[87,76,43], максимальнаянагрузка=[86,52,12,16], скоростьчтения=[81,99,25,41], воздухообмен=[58,81,2,14], вкус=[74,38,90,21];"
                           "Шкаф:цвет=[1,2], размер=[10,12,15];"
                           "Игрушка: цвет=[15,1,12], размер=[10,12,45,14], текстура=[1];"
                           "Мяч: форма=[14], раскрас=[6,14], покрытие=[44,21];"
                           "Cтол:размер=[1,2],цвет=[99,1,3],покрытие=[12].";
...
void outputLineCheck::allClassesEmpty()
{
    QString inStrRecords = "Автомобиль:мощность=[71,82,31,21], совместимость=[87,76,43], максимальнаянагрузка=[86,52,12,16], скоростьчтения=[81,99,25,41], воздухообмен=[58,81,2,14], вкус=[74,38,90,21];"
                           "Шкаф:цвет=[1,2], размер=[10,12,15];"
                           "Игрушка: цвет=[15,1,12], размер=[10,12,45,14], текстура=[1];"
    ...
    QString inStrRules = "Запись принадлежит классу \"С покрытием\", если у нее есть свойство \"нематовый\";"
                         "Запись принадлежит классу \"П л о с к и й\", если у нее есть свойство \"плоский\", которое представлено девятью значениями;"
                         "Запись принадлежит классу \"Синий\", если у нее есть свойство \"краска\", в составе которого есть значение \"1\";"
                         "Запись принадлежит классу \"Матовый\", если у нее есть свойство \"покрытие\" и значение этого свойства равно \"[1, 99]\".";

    QString expectedResult = "\"С покрытием\": -\n"
                             "\"П л о с к и й\": -\n"
                             "\"Синий\": -\n"
                             "\"Матовый\": -";
    Result result;
...
QTEST_APPLESS_MAIN(outputLineCheck)

#include "tst_outputLineCheck.moc"
