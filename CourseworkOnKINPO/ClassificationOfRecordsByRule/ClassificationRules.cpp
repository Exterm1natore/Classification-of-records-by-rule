...
QString ClassificationRules::checkClassificationRules(const QString& strRule)
{
    ...
    for(int i = 0; i < strOneRule.count(); i++)
    {
        ...
        // Проверка что в правиле стоит 4 или 6 кавычек ' " ' (общая проверка на лишние символы)
        ...
        {
            // Хранение текста между кавычками текущего правила
            QStringList substrings;

            // Получение текста между кавычками в текущем правиле
            ...
            // Провека, что текст в кавычках текущего правила не начинается и не заканчивается буквой
            for(int j = 0; j < 2; j++)
            ...
            // Если правило соответсвует 4 паттерну
